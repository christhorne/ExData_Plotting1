...
png("~/Coursera_DataScienceTrack/ExData_Plotting1/plot2.png", width=480, height=480)
# Creates a line plot representing "Global Active Power" over a two day date range
plot(DateSubs$DateTime, DateSubs$Global_active_power, type="l", ylab="Global Active Power (kilowatts)", xlab="")
